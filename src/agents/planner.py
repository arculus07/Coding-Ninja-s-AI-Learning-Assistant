...
def get_planner_agent():
    ...
    Note:- If input doesn't make sense , or say like Hi Hello , anything which is not related to any topic or any question , THEN THE TOPIC WILL BE "Why people should Never ask wrong Questions" just small 2 steps for roadmap
    """
